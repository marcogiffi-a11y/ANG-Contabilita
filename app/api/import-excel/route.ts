...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Sei un esperto contabile italiano. Analizza questo file Excel e mappa le colonne sui campi del gestionale.
...
{
  "cassa_default": "nome banca/conto",
  "mapping": {
    "data_contabile": <indice o null>,
    "data_valuta": <indice o null>,
    "importo": <indice o null>,
    "importo_dare": <indice o null>,
    "importo_avere": <indice o null>,
